...
## [0.28.11](https://github.com/dgrauet/smeltr/compare/v0.28.10...v0.28.11) (2026-09-23)


### Bug Fixes

* **mcp:** page list_sessions and cache settled session summaries ([#262](https://github.com/dgrauet/smeltr/issues/262)) ([86ea96c](https://github.com/dgrauet/smeltr/commit/86ea96cfe91fd88143d78e52418d9d966cfff71f))
...
* parity between CLI, MCP and TUI (attribution, clamp, degraded, memory, filters, trace) ([#255](https://github.com/dgrauet/smeltr/issues/255)) ([345c622](https://github.com/dgrauet/smeltr/commit/345c622c55adcb84415154f187686f48bee4178f))
...
* **probes:** emit one event per crash report, and skip our own aborts ([#228](https://github.com/dgrauet/smeltr/issues/228)) ([29c3b91](https://github.com/dgrauet/smeltr/commit/29c3b91bbc2926a55b09f2a783989ef857f6566b)), closes [#227](https://github.com/dgrauet/smeltr/issues/227)

## [0.28.0](https://github.com/dgrauet/smeltr/compare/v0.27.0...v0.28.0) (2026-08-17)


### Bug Fixes

* consolidate duplicated logic and the defects it hid ([#224](https://github.com/dgrauet/smeltr/issues/224)) ([4bba894](https://github.com/dgrauet/smeltr/commit/4bba8940bad3db571316a9248964446426132a12))
...
* **hook:** stop the Metal capture off the commit path ([#214](https://github.com/dgrauet/smeltr/issues/214)) ([ba313ad](https://github.com/dgrauet/smeltr/commit/ba313ad26ff3c3bed05754559b7967e1a7c36756))

## [0.26.1](https://github.com/dgrauet/smeltr/compare/v0.26.0...v0.26.1) (2026-08-16)


### Bug Fixes

* **hook:** actually arm the Metal capture, and say it aborts the run ([#212](https://github.com/dgrauet/smeltr/issues/212)) ([9bcb978](https://github.com/dgrauet/smeltr/commit/9bcb978e6e5b0633455b76e5453911b974c99c6b))
...
* **record,daemon,core:** honor SMELTR_SESSION_INDEX on the record client ([#188](https://github.com/dgrauet/smeltr/issues/188)) ([#189](https://github.com/dgrauet/smeltr/issues/189)) ([002b7f4](https://github.com/dgrauet/smeltr/commit/002b7f482bf85904686d6b9a375c71b63d53171f))
...
* **cli,analyzer:** flag partial op-level numbers when sampling was disabled ([#165](https://github.com/dgrauet/smeltr/issues/165)) ([#173](https://github.com/dgrauet/smeltr/issues/173)) ([3d13879](https://github.com/dgrauet/smeltr/commit/3d1387952bc92358b54b76a76d17f52e24102f00))
...
* **cli:** resolve session names in sessions show ([#164](https://github.com/dgrauet/smeltr/issues/164)) ([#167](https://github.com/dgrauet/smeltr/issues/167)) ([545ff8d](https://github.com/dgrauet/smeltr/commit/545ff8d2985565807fa27f80de992e892f3c8cfe))

## [0.21.1](https://github.com/dgrauet/smeltr/compare/v0.21.0...v0.21.1) (2026-07-16)


### Bug Fixes

* **metal-hook:** align ARC ownership of new* swizzles with the originals ([#161](https://github.com/dgrauet/smeltr/issues/161)) ([9997954](https://github.com/dgrauet/smeltr/commit/9997954bcf3809bb99afeffc1eed48d6752f8e87)), closes [#160](https://github.com/dgrauet/smeltr/issues/160)
...
* **tui:** gauge shows h:mm:ss past one hour and ■ at end of timeline ([#106](https://github.com/dgrauet/smeltr/issues/106)) ([6f56435](https://github.com/dgrauet/smeltr/commit/6f5643589477a7882e442baeda2cb7f67b3d4be3))
...
* **mcp:** advertise resource templates via resources/templates/list ([f38cb40](https://github.com/dgrauet/smeltr/commit/f38cb40cea92e091d3182c5e9e34121d168b8556))
* **mcp:** resource templates + lightweight session views ([0f44fee](https://github.com/dgrauet/smeltr/commit/0f44fee7c91296bc6cd3f35434c9424f95dbbc21))
* **mcp:** session resource views (metadata/summary) + template data ([7e30188](https://github.com/dgrauet/smeltr/commit/7e3018807b013598cf265172c8b3c005114d4da0))
...
* **cli:** RAII daemon guard in e2e tests — no leaks, generous socket wait ([#97](https://github.com/dgrauet/smeltr/issues/97)) ([7339bb8](https://github.com/dgrauet/smeltr/commit/7339bb810cbeabf27529d73c76a34545806c636b))
...
* **daemon:** harden startup and recovery paths ([#91](https://github.com/dgrauet/smeltr/issues/91)) ([#93](https://github.com/dgrauet/smeltr/issues/93)) ([01ba7de](https://github.com/dgrauet/smeltr/commit/01ba7de0b790596e9a6f21a3766d0439c8af1aa2))
